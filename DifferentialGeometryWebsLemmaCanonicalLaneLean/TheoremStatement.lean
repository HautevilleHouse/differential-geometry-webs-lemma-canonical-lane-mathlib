import DifferentialGeometryWebsLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "differential geometry webs lemma constrained through reviewer bridge, source constants, baseline gates, manifest hashes, and outside-constant dependency count",
